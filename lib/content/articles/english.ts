...
export const englishArticles: Article[] = [
...

  {
    ...
    priority: "P2",
    description:
      "ワーホリ前の耳慣らしに役立つリスニング教材の選び方と、シャドーイング・ディクテーションなど『続けられる』使い方をまとめました。教材はレベルと興味で選ぶのがコツ。ここでの提案は一般的なおすすめであり、合う教材は人によって異なります。",
    content: [
    ...
    keyFacts: [
      { label: "始める時期", value: "出発の2〜3か月前から毎日少しずつ" },
      { label: "教材選びの軸", value: "自分のレベルと興味に合い、続けられること（客観的な正解はない）" },
      { label: "初心者向け", value: "学習者向けポッドキャスト・字幕付き動画・短いニュース" },
      { label: "豪州英語対策", value: "ABCや現地YouTuberなど豪州発の音源を混ぜる" },
      { label: "使い方の基本", value: "理解 → シャドーイング → ディクテーションのサイクル" },
    ],
    steps: [
      {
        title: "レベルに合う素材を1つ選ぶ",
        description:
          "『内容が7〜8割分かる』くらいの難易度が続けやすいです。難しすぎたら一段やさしいものへ。",
      },
      {
        title: "字幕・スクリプトで内容を理解",
        description:
          "まず意味を把握してから聞くと、音の変化やスピードに集中できます。",
      },
      {
        title: "シャドーイングで真似する",
        description:
          "音声に少し遅れて重ねるように声に出し、発音とリズムをコピーします。",
      },
      {
        title: "ディクテーションで穴を確認",
        description:
          "聞き取れなかった箇所を書き取り、スクリプトと照合。自分の弱点が見えます。",
      },
    ],
    tips: [
      "『毎回新しい素材』より『同じ素材を完全に聞き取れるまで繰り返す』ほうが定着が早いです。",
      "通勤・家事の「ながら聞き」で量を確保しつつ、1日5〜10分だけ集中練習を足すと続きます。",
      "豪州英語のアクセントに戸惑うのは普通です。まずは1本を「完全に分かる」まで仕上げてみましょう。",
    ],
    phrases: [
      { en: "Could you recommend a good podcast for learners?", ja: "学習者におすすめのポッドキャストはありますか？", note: "語学学校や友人に聞くとき" },
      { en: "Do you have the subtitles on?", ja: "字幕は付けてますか？", note: "一緒に動画を見るとき" },
      { en: "Sorry, could you say that again a bit slower?", ja: "すみません、もう少しゆっくり言ってもらえますか？", note: "聞き取れないときの必須表現" },
    ],
    faqs: [
      {
        question: "リスニングはどのくらいで伸びますか？",
        answer:
          "個人差がありますが、毎日続けていれば数週間で「耳が慣れてきた」と感じ、数か月で日常会話の多くが聞き取れるようになる人が多いです。大事なのは量と継続で、短時間でも毎日触れるのが近道です。すぐに結果が出なくても、焦らず続けることが一番効きます。",
      },
      {
        question: "教材はお金をかけないとダメですか？",
        answer:
          "いいえ。無料のポッドキャストやYouTube、公共放送のニュースだけでも十分に練習できます。大切なのは教材の値段より『自分のレベルと興味に合っていて続けられるか』です。まずは無料の素材で習慣を作り、必要を感じたら有料教材を足すくらいで十分です。",
      },
    ],
    verifiedAt: "2026-07-27",
    relatedSlugs: [
...

  {
    ...
    priority: "P2",
    description:
      "英語を話す機会を増やしたい人向けに、Language Exchange（言語交換）やMeetup・地域イベントで友達を作り、英語環境を自分でつくるコツと、初対面で使えるフレーズ、安全に参加するための注意点をまとめました。",
    content: [
    ...
    keyFacts: [
      { label: "Language Exchange", value: "お互いの言語を教え合う集まり。間違いを気にせず話せる" },
      { label: "Meetup・イベント", value: "趣味・スポーツなど共通の興味でつながり続けやすい" },
      { label: "探し方", value: "専用アプリ・SNSグループ・図書館/コミュニティセンターの掲示板" },
      { label: "続けるコツ", value: "完璧を目指さず、同じ場に何度も顔を出す" },
      { label: "安全面", value: "初対面は公共の場で・個人情報や金銭のやり取りに注意" },
    ],
    steps: [
      {
        title: "興味に合う集まりを探す",
        description:
          "言語交換・趣味・スポーツなど、自分が楽しめるテーマのイベントをアプリやSNS、図書館の掲示で探します。",
      },
      {
        title: "自己紹介を準備しておく",
        description:
          "名前・出身・ワーホリで来たこと・趣味を1分で話せるようにしておくと、初対面が楽になります。",
      },
      {
        title: "相づち・質問で会話を続ける",
        description:
          "\"That's interesting! How about you?\" のように反応と質問を返すと、会話が自然に続きます。",
      },
      {
        title: "同じ場に繰り返し参加",
        description:
          "一度で友達を作ろうとせず、何度か通って顔なじみを増やすのが結局の近道です。",
      },
    ],
    tips: [
      "最初は聞き役でもOK。相手の話に反応するだけでも会話は成立します。",
      "初対面の相手と会うときは、昼間・公共の場所を選び、個人情報や金銭のやり取りには慎重に。",
      "『英語を教えてもらう』だけでなく、相手の日本語学習も手伝う姿勢だと関係が長続きします。",
    ],
    phrases: [
      { en: "Hi, is it okay if I join you?", ja: "こんにちは、ご一緒してもいいですか？", note: "集まりで輪に入るとき" },
      { en: "I'm here on a working holiday. I'm trying to practise my English.", ja: "ワーホリで来ています。英語を練習したくて。", note: "自己紹介" },
      { en: "That's interesting! How about you?", ja: "それ面白いですね！あなたはどうですか？", note: "会話を続ける相づち＋質問" },
      { en: "Sorry, what does that mean?", ja: "すみません、それどういう意味ですか？", note: "分からない言葉が出たとき" },
      { en: "It was great talking to you. Maybe see you next time?", ja: "話せて楽しかったです。また次回会えたら。", note: "別れ際に関係をつなぐ" },
    ],
    faqs: [
      {
        question: "英語が初級でも参加していいですか？",
        answer:
          "もちろんです。Language Exchange は特に、相手も学ぶ立場なので初級者に慣れている人が多く、間違いを気にせず話せます。最初は自己紹介と相づちだけでも十分。分からなければ聞き返せば大丈夫です。レベルより『参加してみること』のほうがずっと大切です。",
      },
      {
        question: "安全に参加するために気をつけることは？",
        answer:
          "初対面の相手と会うときは、昼間・カフェなど人がいる公共の場所を選びましょう。住所などの個人情報をすぐに教えたり、金銭の貸し借り・投資の勧誘・宗教への強い勧誘などに応じたりするのは避けてください。少しでも不安を感じたら無理せずその場を離れて構いません。信頼できる主催者・団体のイベントから始めると安心です。",
      },
    ],
    verifiedAt: "2026-07-27",
    relatedSlugs: [
...

  {
    ...
    priority: "P2",
    description:
      "ワーホリのあと学生ビザ・就労ビザ・永住を考える人向けに、IELTS・PTEなど英語試験が必要になる場面と選び方の考え方を整理しました。必要スコアやビザ要件は変わるため、最新の要件は必ず移民局（Home Affairs）と各ビザの案内で確認してください。",
    content: [
    ...
    keyFacts: [
      { label: "ワーホリ申請", value: "417/462 のビザ申請自体に英語試験は不要" },
      { label: "試験が要る場面", value: "学生・就労・永住など次のビザ／進学・就職" },
      { label: "主な受入試験", value: "IELTS / PTE Academic / TOEFL iBT / OET / Cambridge C1 など（変更されうる）" },
      { label: "必要スコア", value: "ビザの subclass・目的で異なる → 公式で要確認" },
      { label: "オンライン受験", value: "自宅受験の完全オンライン版はビザ目的では不可（会場受験が必要）" },
    ],
    steps: [
      {
        title: "まず目的を決める",
        description:
          "学生ビザ・就労ビザ・永住・進学・就職など、英語試験が『何のために』必要かをはっきりさせます。",
      },
      {
        title: "申請先の要件を確認",
        description:
          "目指すビザの subclass ページや進学・就職先で、指定の試験・必要スコア・証明の種類を確認します。",
      },
      {
        title: "自分に合う試験を選ぶ",
        description:
          "対面重視ならIELTS、結果の早さ重視ならPTEなど。ただし『申請先が認める試験』であることが大前提です。",
      },
      {
        title: "認定会場で受験する",
        description:
          "ビザ目的なら secure test centre で受験。自宅のオンライン版はビザには使えない点に注意します。",
      },
    ],
    tips: [
      "『とりあえずIELTS』の前に、申請先が認める試験と必要スコアを先に調べると、対策の無駄が減ります。",
      "要件は改定されます（実際に2025年8月に受入試験の扱いが変更）。古い情報をうのみにせず、公式で最新を確認しましょう。",
      "ビザや進学の判断に関わる重要な内容は、移民専門家（登録移民代理人）や進学先に相談すると安心です。",
    ],
    faqs: [
      {
        question: "ワーホリのあと、必ず英語試験を受ける必要がありますか？",
        answer:
          "いいえ、進路によります。帰国する人や、英語試験の要らない進路であれば受験は不要です。試験が必要になるのは、学生ビザ・就労ビザ・永住など『英語力の証明を求めるビザ』や、一部の進学・就職を目指す場合です。まず自分の目的を決め、その申請先が英語試験を求めるかどうかを確認するのが先決です。",
      },
      {
        question: "IELTSとPTE、どちらを受ければいいですか？",
        answer:
          "多くのビザ・進学では両方とも認められますが、『申請先が認める試験か』を最初に確認するのが鉄則です。そのうえで、試験官と対面で話す形式が良ければIELTS、コンピューターで受けて結果が比較的早いほうが良ければPTE、という選び方が一般的です。必要スコアはビザや目的で異なり変わりうるため、移民局と申請先の最新の案内で必ず確認してください。",
      },
    ],
    verifiedAt: "2026-07-27",
    officialSources: [
      {
        label: "Department of Home Affairs｜English language visa requirements（受入試験・要件。2025年8月7日から変更）",
        url: "https://immi.homeaffairs.gov.au/help-support/meeting-our-requirements/english-language",
        accessedAt: "2026-07-27",
      },
      {
        label: "IELTS 公式（試験の種類・申込）",
        url: "https://ielts.org/",
        accessedAt: "2026-07-27",
      },
      {
        label: "PTE Academic 公式（Pearson）",
