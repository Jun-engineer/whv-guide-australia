...
export const arrivalArticles: Article[] = [
...

  {
    ...
    hub: "daily-life",
    description:
      "オーストラリアの郵便（Australia Post）の使い方を解説。手紙・荷物の送り方と住所表記、追跡、MyPost・PO Box・Parcel Lockerでの受け取り、不在時の再受け取りの流れをまとめました。",
    content: [
      "オーストラリアの郵便は Australia Post（AusPost）が中心です。手紙・小包の発送や受け取り、荷物の追跡、私書箱（PO Box）などのサービスがあり、郵便局（Post Office）は街なかに広くあります。海外通販や国内の荷物を受け取る機会が多いため、基本の使い方を押さえておくと安心です。荷物はおおむね発送予定日から5営業日以内に届くのが目安ですが、地域や時期で前後します。",
      "受け取りを便利にする無料サービスが『MyPost』です。無料の個人アカウントを作ると、荷物の追跡、配送中の転送（再配達先の変更）、通知の受け取りなどができます。自宅で受け取りにくい人は、街の受け取りロッカー『Parcel Locker』や郵便局留めを配送先に指定できます。長期的に住所を固定したい場合は有料の私書箱（PO Box。年会費がかかります）も選べます。引っ越しや一時帰国の際は『mail redirection（転送）／mail hold（保留）』が使えます。",
      "住所表記と受け取りのコツは、①宛先は『名前／番地・通り名／suburb・州・郵便番号』の順で英語表記、②不在で持ち帰られた荷物は、不在票やアプリの案内に従って最寄りの受け取り拠点（郵便局・パーセルロッカー等）で受け取り、③受け取り時は本人確認のため写真付きIDを求められることがある、です。追跡番号はアプリ（AusPostアプリ）やサイトで確認できます（本記事の確認日: 2026-07-27）。",
    ],
    keyFacts: [
      { label: "運営", value: "Australia Post（AusPost）" },
      { label: "MyPost", value: "無料の個人アカウント（追跡・転送・通知）" },
      { label: "受け取り", value: "自宅・Parcel Locker・郵便局留めから選べる" },
      { label: "PO Box", value: "私書箱。年会費がかかる" },
      { label: "配達目安", value: "おおむね発送から5営業日以内（地域差あり）" },
    ],
    steps: [
      { title: "MyPostに登録", description: "無料の MyPost アカウントを作り、荷物の追跡・配送中の転送・通知を使えるようにします。" },
      { title: "受け取り方法を選ぶ", description: "自宅受け取りが難しい場合は Parcel Locker や郵便局留め、長期なら有料の PO Box を検討します。" },
      { title: "住所を正しく表記", description: "名前／番地・通り名／suburb・州・郵便番号の順で英語表記します。" },
      { title: "不在時は拠点で受け取り", description: "不在票やアプリの案内に従い、最寄りの拠点で受け取ります。写真付きIDが必要な場合があります。" },
    ],
    tips: [
      "追跡番号はAusPostアプリで管理すると、配達状況の通知が受け取れて便利です。",
      "海外通販の荷物は Parcel Locker 宛にすると、不在でも24時間受け取りやすくなります。",
      "引っ越しが多いワーホリは mail redirection（転送）を使うと、旧住所宛の郵便を取りこぼしにくくなります。",
    ],
    faqs: [
      {
        question: "自宅で荷物を受け取れないときは？",
        answer:
          "街の受け取りロッカー『Parcel Locker』や郵便局留めを配送先に指定できます。無料の MyPost アカウントで配送中の転送や通知も設定できます。不在で持ち帰られた場合は、不在票やアプリの案内に従って最寄りの拠点で受け取ります。",
      },
      {
        question: "荷物の受け取りに身分証は必要ですか？",
        answer:
          "受け取り拠点での本人確認のため、写真付きID（パスポート・運転免許証など）を求められることがあります。案内された持ち物を確認して受け取りに行きましょう。追跡番号はAusPostアプリやサイトで確認できます。",
      },
    ],
    warnings: [
      "AusPostを装った偽SMS・偽メール（不在通知・再配達を装い個人情報や支払いを求める）が出回っています。リンクを不用意に開かず、追跡は必ず公式アプリ・公式サイトで行い、不審なものは AusPost の詐欺情報ページで確認してください。",
    ],
    verifiedAt: "2026-07-27",
    officialSources: [
      {
        label: "Australia Post｜Receiving（追跡・PO Box・MyPost・Parcel Locker）",
...

  {
    ...
    hub: "daily-life",
    description:
      "オーストラリアの公共図書館（public library）の活用法を解説。無料の会員登録、Wi-Fi・パソコン・印刷、本やeブックの貸出、英語学習や地域サービスなど、ワーホリに役立つ使い方をまとめました。",
    content: [
      "オーストラリアの公共図書館（public library）は、地域の council（自治体）や州立図書館が運営し、多くは無料で会員登録できます。ワーホリにとっては、無料Wi-Fi・パソコン利用・冷暖房の効いた学習スペース・本やeブックの貸出などが使える便利な場所です。仕事探しの合間や、家にネットがないときの作業場所としても重宝します。",
      "主なサービスは、①無料Wi-Fiとパソコン（インターネット利用）、②プリンター（印刷・コピー・スキャン。有料の場合あり）、③本・雑誌・DVD・eブック/オーディオブックの貸出（アプリで電子書籍を借りられる図書館も多い）、④英語学習の教材や、英会話クラブ・地域イベントなどのプログラム、です。会員証があれば電子リソースを自宅から使えることもあります。",
      "使い方はシンプルで、①最寄りの図書館の会員登録（本人確認書類や滞在先住所の確認を求められることがあります）、②Wi-Fiやパソコンはその場で利用、③本を借りるときは会員証で貸出手続き、返却期限を守る、です。印刷料金・貸出ルール・開館時間・提供プログラムは図書館ごとに異なるため、各図書館（council・州立図書館）の公式情報で確認してください（本記事の確認日: 2026-07-27）。",
    ],
    keyFacts: [
      { label: "運営", value: "自治体（council）・州立図書館" },
      { label: "会員登録", value: "多くは無料（本人確認・住所確認の場合あり）" },
      { label: "無料で使える", value: "Wi-Fi・パソコン・学習スペース" },
      { label: "貸出", value: "本・雑誌・eブック/オーディオブック" },
      { label: "英語学習", value: "教材・英会話クラブ・地域イベント" },
    ],
    steps: [
      { title: "最寄りの図書館を探す", description: "滞在地の council や州立図書館の公式で、近くの公共図書館と開館時間を確認します。" },
      { title: "会員登録する", description: "多くは無料。本人確認書類や滞在先住所の確認を求められることがあります。" },
      { title: "Wi-Fi・パソコンを使う", description: "無料Wi-Fiやパソコンはその場で利用できます。印刷は有料の場合があります。" },
      { title: "本やeブックを借りる", description: "会員証で貸出手続き。返却期限を守ります。アプリで電子書籍を借りられる図書館も多いです。" },
    ],
    tips: [
      "家にネットがない期間は、図書館の無料Wi-Fi・パソコンが作業や求人応募に役立ちます。",
      "英会話クラブや地域イベントを開く図書館もあり、無料で英語を練習し友達を作る機会になります。",
      "会員証があれば、電子書籍・オーディオブックを自宅のアプリから無料で借りられることがあります。",
    ],
    faqs: [
      {
        question: "ワーホリでも図書館の会員になれますか？",
        answer:
          "多くの公共図書館は地域に住む人なら無料で会員登録できます。登録時に本人確認書類や滞在先住所の確認を求められることがあります。会員になると本の貸出や、電子リソースの自宅利用ができる場合があります。詳細は各図書館の公式で確認してください。",
      },
      {
        question: "図書館の印刷やWi-Fiは無料ですか？",
        answer:
          "Wi-Fiやパソコン利用は多くの図書館で無料です。印刷・コピーは有料の場合があります。料金や利用ルールは図書館ごとに異なるため、各図書館（council・州立図書館）の公式情報で確認してください。",
      },
    ],
    warnings: [
      "印刷料金・貸出ルール・開館時間・提供プログラムは図書館ごとに異なります。断定せず、各図書館（council・州立図書館）の公式情報で最新を確認してください。",
    ],
    verifiedAt: "2026-07-27",
    officialSources: [
      {
        label: "State Library of NSW｜Public library services（公共図書館サービスの概要）",
        url: "https://www.sl.nsw.gov.au/public-library-services",
        accessedAt: "2026-07-27",
      },
    ],
    relatedSlugs: [
