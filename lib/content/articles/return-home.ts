...
export const returnHomeArticles: Article[] = [
...

  {
    ...
    hub: "return-home",
    priority: "P2",
    searchIntent: "帰国後の逆カルチャーショックの乗り越え方とキャリアの再スタート",
    description:
      "ワーホリから帰国した後に感じる『逆カルチャーショック（reverse culture shock）』の正体と、よくある症状・原因・時間の経過による変化、そして落ち着かない時期を乗り越えながらキャリアを再始動するための実践的な工夫をまとめます。つらさが続く場合の相談先も案内します。",
    content: [
    ...
    keyFacts: [
      { label: "逆カルチャーショックとは", value: "帰国後に母国へなじみにくく感じる適応反応" },
      { label: "よくある症状", value: "窮屈さ・豪州の理想化・孤独・無気力・落ち着かなさ" },
      { label: "経過", value: "多くは数週間〜数か月で徐々に和らぐ" },
      { label: "対処", value: "現象を知る・生活を整える・つながる・経験を活かす" },
      { label: "つらい時", value: "我慢せず専門家（かかりつけ医・相談窓口）へ" },
    ],
    steps: [
      { title: "現象を知る", description: "逆カルチャーショックを『適応の過程』と理解し、自分を責めないようにします。" },
      { title: "生活を整える", description: "睡眠・食事・運動のリズムを立て直し、心身の土台を整えます。" },
      { title: "つながる", description: "同じ経験を持つ人やコミュニティとつながり、経験を語れる場を持ちます。" },
      { title: "経験を棚卸し", description: "ワーホリで得たスキル・価値観・方向性を書き出して整理します。" },
      { title: "小さく動き出す", description: "完璧な再適応を焦らず、小さな目標から少しずつ行動します。" },
      { title: "つらければ相談", description: "落ち込みや不眠が続くときは、かかりつけ医や相談窓口・専門家に相談します。" },
    ],
    tips: [
      "帰国直後は予定を詰め込みすぎず、休息と再適応の時間を確保しましょう。",
      "オーストラリアを『理想化』しすぎず、良かった点を日本の生活に取り入れる視点が役立ちます。",
      "キャリアは焦って決めず、経験の棚卸しと資金計画を先に。落ち着いて選ぶほど納得のいく再始動になります。",
    ],
    warnings: [
      "この記事は一般的な情報で、医療・心理の専門的アドバイスではありません。気分の落ち込み・不眠・食欲不振などが続く、または日常生活に支障が出る場合は、我慢せず医療機関や相談窓口など専門家に相談してください。",
      "命に関わる危険を感じたときは、迷わず住んでいる国の緊急連絡先（日本の場合は119／いのちの電話等）に連絡してください。豪州の電話番号（例：Lifeline 13 11 14）は原則オーストラリア国内向けです。",
    ],
    faqs: [
      {
        question: "逆カルチャーショックはどれくらい続きますか？",
        answer:
          "個人差がありますが、多くは数週間から数か月かけて徐々に和らいでいきます。現象を理解し、生活リズムを整え、経験を語れる人とつながることで楽になりやすいです。長引いたり日常生活に支障が出たりする場合は、専門家に相談してください。",
      },
      {
        question: "帰国後すぐに就職先を決めるべきですか？",
        answer:
          "焦って決める必要はありません。まず経験の棚卸しをして方向性を整理し、選択肢を広く見てから動くほうが納得のいく再始動になります。ただし当面の生活費の計画は並行して立てておくと、焦りが減って落ち着いて選べます。",
      },
    ],
    verifiedAt: "2026-08-02",
    officialSources: [
      { label: "healthdirect｜Mental health（メンタルヘルスの相談・受診の目安）", url: "https://www.healthdirect.gov.au/mental-health", accessedAt: "2026-08-02" },
      { label: "Beyond Blue（不安・抑うつの情報とサポート）", url: "https://www.beyondblue.org.au/", accessedAt: "2026-08-02" },
      { label: "Lifeline Australia｜13 11 14（24時間・豪州内向けの危機相談）", url: "https://www.lifeline.org.au/", accessedAt: "2026-08-02" },
    ],
    relatedSlugs: ["leaving-australia-checklist", "use-wh-experience-in-resume", "mental-health", "ielts-pte-after-wh"],
    updatedAt: "2026-08-02",
    published: true,
  },

  {
    ...
    hub: "return-home",
    priority: "P3",
    searchIntent: "帰国後・海外からオーストラリアの無犯罪証明（police check）を取得する方法",
    description:
      "帰国後に、他国のビザ申請・就労・移住などでオーストラリアの無犯罪証明（police check／police certificate）が必要になった場合の取得方法を解説します。海外からの申請で使われるAFP（連邦警察）の National Police Check と、指紋が必要になるケース、在豪中に取得する場合との違いをまとめます。",
    content: [
    ...
    keyFacts: [
      { label: "海外からの申請", value: "国外からでも申請可能" },
      { label: "移民・ビザ目的", value: "AFP（連邦警察）のNational Police Checkが一般的" },
      { label: "指紋", value: "用途により指紋付きが必要（居住国で採取）" },
      { label: "名前ベース", value: "ACIC認定機関・州警察のチェック（在豪就労等）" },
      { label: "有効期限", value: "提出先が発行からの新しさを求めることが多い" },
    ],
    steps: [
      { title: "提出先の要件を確認", description: "相手国の移民当局や雇用主が求める機関・様式（AFP指紋付きか等）を確認します。" },
      { title: "ルートを選ぶ", description: "移民・海外目的はAFP、名前ベースで足りる用途はACIC認定機関を選びます。" },
      { title: "オンライン申請", description: "AFPのオンラインで目的を選び、本人確認書類を提出して支払います。" },
      { title: "指紋が必要なら採取", description: "指紋付きが必要な場合、居住国で所定の様式に沿って指紋を採取・提出します。" },
      { title: "証明を受領・提出", description: "発行された証明を、有効期限に注意して提出先に提出します。" },
    ],
    tips: [
      "将来ビザ・移住で必要になりそうなら、出国前の取得も検討を。海外からの指紋提出の手間を省けます。",
      "証明には発行日があり、提出先が『発行から◯か月以内』を求めることが多いです。必要な時期に合わせて取得しましょう。",
      "『どの機関の・どの様式か』は提出先で異なります。先に相手の要件を確認してから申請すると二度手間を防げます。",
    ],
    warnings: [
      "取得ルート（AFP／ACIC認定機関）・指紋の要否・手数料・処理日数・有効期限は、用途や提出先によって異なり、随時変わります。実際の手順と要件は必ずAFP・ACICの公式情報と、提出先の求める条件で確認してください。この記事は一般的な情報提供です。",
    ],
    faqs: [
      {
        question: "帰国後でもオーストラリアの無犯罪証明は取れますか？",
        answer:
          "はい、オーストラリア国外からでも申請できます。ビザ・移住・海外雇用などの目的では、AFP（連邦警察）のNational Police Checkが一般的で、用途によっては居住国での指紋採取が必要になります。手順・手数料・日数はAFPの公式案内で確認してください。",
      },
      {
        question: "在豪中に取った police check と何が違いますか？",
        answer:
          "在豪中の就労では、ACIC認定機関や州警察の『名前ベース』のチェックが一般的です。一方、他国のビザ・移住など公的・移民目的や海外からの申請では、AFPの証明（用途により指紋付き）が求められることが多く、提出先が指定する機関・様式に合わせる必要があります。",
      },
    ],
    verifiedAt: "2026-08-02",
    officialSources: [
      { label: "Australian Federal Police｜National police checks（海外・移民目的の警察証明）", url: "https://www.afp.gov.au/what-we-do/services/criminal-records/national-police-checks", accessedAt: "2026-08-02" },
      { label: "Australian Criminal Intelligence Commission｜National Police Checking Service", url: "https://www.acic.gov.au/services/national-police-checking-service", accessedAt: "2026-08-02" },
    ],
    relatedSlugs: ["leaving-australia-checklist", "police-check-guide", "working-with-children-check"],
    updatedAt: "2026-08-02",
    published: true,
  },
];
